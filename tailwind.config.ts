    ...
    extend: {
      ...
      keyframes: {
        ...
        "seal-press": {
          ...
          "60%": { opacity: "1", transform: "scale(0.96) rotate(0deg)" },
      ...
      animation: {
        ...
        "seal-press": "seal-press 0.9s cubic-bezier(0.22, 1, 0.36, 1) forwards",
        "map-zoom": "map-zoom 1.4s cubic-bezier(0.22, 1, 0.36, 1) forwards",
